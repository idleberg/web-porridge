...
var WebPorridgeDB = (function () {
    function WebPorridgeDB(userOptions) {
        ...
        this.store = new idb_keyval_1.Store(this.options.dataBaseName, this.options.storeName);
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4, idb_keyval_1.get(keyName, this.store)];
                    case 1:
                    ...
                    case 3: return [2, (value && util_1.maybeDeserialize(value) && options.decodeJSON === true)
                            ? JSON.parse(value)
