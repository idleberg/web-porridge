...
test('String', t => {
  localPorridge.setItem('demo', shared.actualString);
...
test('Valid JSON', t => {
  localPorridge.setItem('demo', shared.actualObject);
...
test('Invalid JSON', t => {
  localPorridge.setItem('demo', shared.invalidJSON);
...
test('Object key', t => {
  localPorridge.setItem('demo', shared.actualObject);
  localPorridge.setItem('demo', shared.actualString, 'nested');
